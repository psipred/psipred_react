...
export function parse_presults(file, ann_list, type)
{
  ...
  lines.forEach(function(line, i){
    ...
    if(type === 'dgen'){
      ...
      pseudo_table += "<td><input class='button' type='button' onClick='window.open(\"http://127.0.0.1:3000/model/?aln="+(ann_list[table_hit+"_"+i].aln)+"\", \"Popup\", \"scrolling=yes, scrollbars=yes status width=500 height=600 top=30\")' value='View' /></td>";
