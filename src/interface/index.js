              ...
              <nav className="navbar navbar-static-top" role="navigation">
                  ...
                  <div className="container-fluid">
                        <div className="navbar-header" style={{ 'paddingTop': '5px'}}>
                          <h4 className="psipred_title"><a class="psipred_title" href="https://www.ucl.ac.uk/engineering/computer-science"><b>UCL Computer Science</b></a></h4>
                        </div>
                        <div className="collapse navbar-collapse" id="navbar-collapse">
                          <div className="nav navbar-nav navbar-right">
                            ...
                            <a href="https://bioinf.cs.ucl.ac.uk/index.html" alt="UCL"><img alt="UCL Logo" height="50px" class="ucl-pad" src="https://bioinf.cs.ucl.ac.uk/assets/images/ucl-logo.svg" /></a>
                          </div>
                        </div>
                  </div>
              </nav>
