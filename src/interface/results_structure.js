  ...
  componentDidUpdate(prevProps) {
    ...
    for(let key in this.state.merizo_results){
      ...
      if(key.includes(".pdb2")){
        ...
        pdb_options.innerHTML = '<h4><b>PDB Options</b></h4> <h5>Colouration</h5>  <button id="colorByDomains">Colour by Domains</button> <button id="colorByBFactor">Colour by b-factor: temp</button> <button id="colorByplDDT">Colour by b-factor: plDDT</button> '
